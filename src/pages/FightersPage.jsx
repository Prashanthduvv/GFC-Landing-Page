...
import { 
  FaSearch, FaFilter, FaTimes, FaInstagram, FaTwitter, 
  FaArrowRight, FaTrophy, FaChartLine, FaWeightHanging,
  FaCalendarAlt, FaUserFriends, FaMedal, FaHeart,
  FaShieldAlt, FaFistRaised, FaChartBar, FaLink,
  FaEnvelope, FaBell, FaCheckCircle,FaTicketAlt 
} from "react-icons/fa";
...
const fightersData = [
  { 
    ...
    country: "India",
    ranking: 1,
    social: { instagram: "@arjunmalik", twitter: "@arjun_malik" },
  ...
  { 
    ...
    country: "India",
    ranking: 1,
    social: { instagram: "@meera.iyer", twitter: "@meera_iyer" },
  ...
  { 
    ...
    country: "India",
    ranking: 2,
    social: { instagram: "@zaynkhan", twitter: "@zayn_khan" },
  ...
  { 
    ...
    country: "India",
    ranking: 3,
    social: { instagram: "@rajivmenon", twitter: "@rajiv_menon" },
  ...
  { 
    ...
    country: "India",
    ranking: 2,
    social: { instagram: "@anjalireddy", twitter: "@anjali_reddy" },
  ...
  { 
    ...
    country: "India",
    ranking: 1,
    social: { instagram: "@karansingh", twitter: "@karan_singh" },
    bio: "Devastating heavyweight with one-punch KO power."
  },
];

const weightClasses = ["All", "Welterweight", "Strawweight", "Lightweight", "Middleweight", "Flyweight", "Heavyweight"];
const sortOptions = ["Ranking", "Name A-Z", "Record", "Most KOs", "Most Submissions"];
        ...
        <div className="p-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-center">
            <div className="text-center">
              <img src={fighter.image} alt={fighter.name} className="w-32 h-32 md:w-40 md:h-40 rounded-full mx-auto object-cover border-4 border-red-500" />
              <div className="flex justify-center gap-3 mt-3">
                <a href="#" className="text-gray-400 hover:text-red-500 transition"><FaInstagram size={18} /></a>
                <a href="#" className="text-gray-400 hover:text-red-500 transition"><FaTwitter size={18} /></a>
              </div>
            </div>
            <div className="md:col-span-2 text-center md:text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase">{fighter.name}</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="bg-white/5 rounded-lg p-3 text-center">
              ...
              <p className="text-green-500 text-xs">{fighter.wins}W - {fighter.losses}L</p>
            </div>
            <div className="bg-white/5 rounded-lg p-3 text-center">
              <p className="text-gray-400 text-xs uppercase">Finishes</p>
              <p className="text-xl font-bold text-white">{fighter.knockouts + fighter.submissions}</p>
              <p className="text-yellow-500 text-xs">{fighter.knockouts} KO / {fighter.submissions} SUB</p>
            </div>
            <div className="bg-white/5 rounded-lg p-3 text-center">
              <p className="text-gray-400 text-xs uppercase">Height / Reach</p>
              <p className="text-lg font-bold text-white">{fighter.height} / {fighter.reach}</p>
            </div>
            <div className="bg-white/5 rounded-lg p-3 text-center">
          ...
          {/* Performance Metrics */}
          <div className="mt-6">
            <h3 className="text-lg font-bold uppercase mb-3">Performance Metrics</h3>
            <div className="space-y-3">
              <div>
                ...
                <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div className="bg-red-600 h-full rounded-full" style={{ width: `${65 + Math.random() * 25}%` }} />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
                ...
                <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div className="bg-blue-600 h-full rounded-full" style={{ width: `${40 + Math.random() * 40}%` }} />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-1">
                ...
                <div className="h-2 bg-gray-700 rounded-full overflow-hidden">
                  <div className="bg-yellow-600 h-full rounded-full" style={{ width: `${50 + Math.random() * 40}%` }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-8">
            <button onClick={() => window.dispatchEvent(new CustomEvent("openTicketModal"))} className="flex-1 bg-red-600 hover:bg-red-700 transition py-3 rounded-lg font-bold uppercase tracking-wide flex items-center justify-center gap-2">
              <FaTicketAlt /> WATCH FIGHT LIVE
            </button>
            <button className="flex-1 border border-white/20 hover:border-red-600 transition py-3 rounded-lg font-bold uppercase tracking-wide flex items-center justify-center gap-2">
...
export default function FightersPage() {
  ...
  // Stats for counters
  const stats = [
    { label: "TOTAL FIGHTERS", value: fightersData.length, icon: FaUserFriends, suffix: "" },
    { label: "UNDEFEATED", value: fightersData.filter(f => f.losses === 0).length, icon: FaTrophy, suffix: "" },
    { label: "TOTAL KO/TKO", value: fightersData.reduce((sum, f) => sum + f.knockouts, 0), icon: FaFistRaised, suffix: "" },
    { label: "TOTAL SUBMISSIONS", value: fightersData.reduce((sum, f) => sum + f.submissions, 0), icon: FaMedal, suffix: "" },
  ];
...
<section className="relative flex items-center bg-black overflow-hidden" style={{ minHeight: "100vh", height: "100vh", maxHeight: "900px" }}>
  ...
  <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
    <div className="max-w-2xl">
      <p className="text-red-500 uppercase tracking-[4px] text-xs sm:text-sm mb-3 font-semibold">THE WARRIORS</p>
      ...
      <p className="text-gray-300 text-sm sm:text-base mt-4 leading-relaxed max-w-lg">
      ...
      {/* ================= STATS COUNTERS ================= */}
      <section ref={statsRef} className="py-10 border-y border-red-900/20 bg-gradient-to-b from-black to-[#050505]">
      ...
      <section className="py-6 border-b border-white/10 bg-[#050505]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-500 text-xs">Showing {filteredFighters.length} of {fightersData.length} fighters</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          {filteredFighters.length === 0 ? (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-20">
              <p className="text-gray-400 text-lg">No fighters found matching your criteria.</p>
              <button 
                onClick={() => { setSelectedWeight("All"); setSearchTerm(""); setSortBy("Ranking"); }}
              ...
              {filteredFighters.map((fighter, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 text-center">
                    <h3 className="text-lg sm:text-xl font-bold tracking-wide uppercase text-white">{fighter.name}</h3>
                    <p className="text-red-500 text-xs uppercase font-semibold mt-1">{fighter.tag1}</p>
                    <p className="text-red-500 text-xs uppercase">{fighter.tag2}</p>
                    
                    {/* Stats Row */}
                    <div className="flex justify-center gap-4 mt-3 text-center">
                      <div>
                        <p className="text-gray-400 text-[9px] uppercase">KOs</p>
                        <p className="text-white text-sm font-bold">{fighter.knockouts}</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-[9px] uppercase">Subs</p>
                        <p className="text-white text-sm font-bold">{fighter.submissions}</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-[9px] uppercase">Style</p>
                        <p className="text-white text-sm font-bold">{fighter.style}</p>
                      </div>
                    </div>
                    
                    <button 
                      onClick={(e) => { e.stopPropagation(); setSelectedFighter(fighter); }}
                      className="mt-3 w-full border border-gray-600 hover:bg-red-600 hover:border-red-600 px-4 py-2 text-[10px] sm:text-xs uppercase font-semibold transition-all duration-300 rounded-lg text-white"
                    >
                      VIEW FULL PROFILE
                    </button>
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-red-900/10 via-black to-black border-y border-red-900/20">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase" style={{ fontFamily: "'Anton', sans-serif" }}>Fighter <span className="text-red-600">Spotlight</span></h2>
            <p className="text-gray-400 text-sm mt-2">Get to know our champions</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="relative rounded-2xl overflow-hidden group">
              <img src="/images/f1.png" alt="Featured Fighter" className="w-full h-80 object-cover group-hover:scale-105 transition duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent" />
            </div>
            <div className="text-center md:text-left">
              <div className="inline-block px-3 py-1 bg-red-600/20 border border-red-600 rounded-full text-xs font-semibold mb-3">FEATURED ATHLETE</div>
              <h3 className="text-3xl font-black uppercase">ARJUN MALIK</h3>
              <p className="text-red-500 text-lg">"The Technician"</p>
              <p className="text-gray-300 mt-4 leading-relaxed">
                Undefeated welterweight champion with an 8-0 record. Known for his technical striking 
                and elite fight IQ. Training out of New Delhi, Malik is considered one of India's 
                most promising MMA talents.
              </p>
              <div className="flex flex-wrap gap-3 mt-6 justify-center md:justify-start">
                <button onClick={() => setSelectedFighter(fightersData[0])} className="bg-red-600 hover:bg-red-700 transition px-6 py-2 rounded-lg text-sm font-bold uppercase">VIEW PROFILE</button>
                <button onClick={handleGetTickets} className="border border-white/30 hover:border-red-600 transition px-6 py-2 rounded-lg text-sm font-bold uppercase">WATCH NEXT FIGHT</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-black uppercase mb-4" style={{ fontFamily: "'Anton', sans-serif" }}>
              Want to See More Fighters?<br />
            ...
            <p className="text-gray-300 max-w-2xl mx-auto mb-8 text-sm sm:text-base leading-relaxed">
              Get exclusive access to fighter interviews, behind-the-scenes content, 
              early event notifications, and meet your favorite athletes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2"><FaHeart /> JOIN THE MOVEMENT</span>
              </motion.button>
              <motion.button 
                whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
            ...
            <p className="mt-6 text-gray-500 text-xs">Join 5,000+ members already part of the movement</p>
          </motion.div>
        </div>
      </section>
      ...
      {/* ================= FIGHTER DETAIL MODAL ================= */}
      <AnimatePresence>
        {selectedFighter && <FighterDetailModal fighter={selectedFighter} onClose={() => setSelectedFighter(null)} />}
      </AnimatePresence>
